 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Tue Aug  1 15:31:43 2017
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME StepMotor
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          8
/* Input Port  0 */
#define IN_PORT_0_NAME      x_target
...
/* Input Port  1 */
#define IN_PORT_1_NAME      y_target
...
extern void StepMotor_Outputs_wrapper(const real_T *x_target,
...
{
    const real_T   *x_target  = (const real_T*) ssGetInputPortSignal(S,0);
    const real_T   *y_target  = (const real_T*) ssGetInputPortSignal(S,1);
    const real_T   *x_pulse  = (const real_T*) ssGetInputPortSignal(S,2);
    const real_T   *y_pulse  = (const real_T*) ssGetInputPortSignal(S,3);
    const real_T   *z_pulse  = (const real_T*) ssGetInputPortSignal(S,4);
    const real_T   *x_limit  = (const real_T*) ssGetInputPortSignal(S,5);
    const real_T   *y_limit  = (const real_T*) ssGetInputPortSignal(S,6);
    const real_T   *z_input  = (const real_T*) ssGetInputPortSignal(S,7);
    real_T        *x_step  = (real_T *)ssGetOutputPortRealSignal(S,0);
    real_T        *y_step  = (real_T *)ssGetOutputPortRealSignal(S,1);
    real_T        *z_step  = (real_T *)ssGetOutputPortRealSignal(S,2);
    real_T        *x_dir  = (real_T *)ssGetOutputPortRealSignal(S,3);
    real_T        *y_dir  = (real_T *)ssGetOutputPortRealSignal(S,4);
    real_T        *z_dir  = (real_T *)ssGetOutputPortRealSignal(S,5);
    real_T        *enable  = (real_T *)ssGetOutputPortRealSignal(S,6);
    real_T        *index  = (real_T *)ssGetOutputPortRealSignal(S,7);

    StepMotor_Outputs_wrapper(x_target, y_target, x_pulse, y_pulse, z_pulse, x_limit, y_limit, z_input, x_step, y_step, z_step, x_dir, y_dir, z_dir, enable, index);
